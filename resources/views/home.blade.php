...
<div class="container">
    <div class="row">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class='main_search_form2'>
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" placeholder="Enter Complex Name" name="input2" >
                        </div>
                        <div class="col-sm-2">
                           <input type="button" class="form-control readonly disabled id" placeholder="" name="or" value="or">
                        </div>
                        <div class="col-sm-4">
                            {!! Form::select('selected2', $complexes, null, ['class' => 'form-control']) !!}
                        </div>
                        <div class="col-sm-2">
                            {{Form::submit('Go', array('class' => 'btn btn-success')) }}
                        </div>
        ...
        <!--  col-md-10 -->
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">Find a propery by Owner Id</div>
                ...
                <div class="panel-body">
                    ...
                    <div class='main_search_form3'>
                        ...
                        {{ Form::open(array('method' =>'POST','url'=>'/street')) }}
                        <div class="col-sm-4">
                            <input type="text" class="form-control" placeholder="Enter Owner Id" name="input" >
                        </div>
                        <div class="col-sm-2">
                           <input type="button" class="form-control readonly disabled id" placeholder="" name="or" value="or">
                        </div>
